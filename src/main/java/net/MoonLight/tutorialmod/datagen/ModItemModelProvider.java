...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        handheldItem(ModItems.RUBIX_CUBE);
        ...
        trimmedArmorItem(ModItems.USELESS_HELMET);
        trimmedArmorItem(ModItems.USELESS_CHESTPLATE);
        trimmedArmorItem(ModItems.USELESS_LEGGINGS);
        trimmedArmorItem(ModItems.USELESS_BOOTS);
        simpleBlock(ModBlocks.UGLY_BLOCK);
        simpleBlock(ModBlocks.USELESS_BLOCK);
    ...
    private ItemModelBuilder simpleBlock(RegistryObject<Block> block) {
        ...
        return withExistingParent(block.getId().getPath(),
                new ResourceLocation("block/generated")).texture("all",
